...
export const GLOSSARY = {
  ...
  recommend_score: {
    name: '推荐分',
    desc: '综合推荐评分(0-100) = 价值分×30% + 技术分×40% + 筹码分×30%。',
    detail: '80+ 强烈推荐｜65+ 值得关注｜50+ 观察｜<50 暂不建议',
  },
  value_score: {
    name: '价值分',
    desc: '估值维度评分：PE 5-15 低估(+40)、PB<1.5(+30)、市值>200亿(+30)。',
  },
  technical_score: {
    name: '技术分',
    desc: '技术面评分：MA20上行(+30)、MACD多头(+25)、RSI健康(+20)、量比>1(+25)。',
  },
  chip_score: {
    name: '筹码分',
    desc: '筹码面评分：获利盘<30%(+40)、集中度<15%(+30)、价格接近支撑位(+30)。',
  },
